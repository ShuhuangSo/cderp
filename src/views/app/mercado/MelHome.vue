...
<script>
import Listing from "@/components/app/mercado/Listing";
import Categories from "@/components/app/mercado/Categories";
import Seller from "@/components/app/mercado/Seller";

export default {
  name: "MelHome",
  components:{
    Listing, Categories, Seller
  },
  data(){
    return{
      activeName: 'first',
